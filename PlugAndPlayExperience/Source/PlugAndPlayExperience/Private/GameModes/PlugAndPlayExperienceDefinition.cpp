...
#include "GameModes/PlugAndPlayExperienceDefinition.h"
#include "GameFeatureAction.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PlugAndPlayExperienceDefinition)

#define LOCTEXT_NAMESPACE "PlugAndPlaySystem"

UPlugAndPlayExperienceDefinition::UPlugAndPlayExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UPlugAndPlayExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UPlugAndPlayExperienceDefinition::UpdateAssetBundleData()
{
